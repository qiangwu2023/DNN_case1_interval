...
corr = 0.5 
n_layer = 3 
Set_node = np.array([50, 50, 50]) 
n_epoch = 200 
Set_lr = np.array([2.2e-4, 3e-4, 5e-4]) 
Beta = 1 
...
plt.ylim(-2,2) 
ax1_1.set_title("Case 4, n=500",fontsize=10)
...
plt.ylim(-2,2)
ax1_2.set_title("Case 4, n=1000",fontsize=10) 
...
plt.ylim(-2,2) 
ax1_3.set_title("Case 4, n=2000",fontsize=10) 
...
plt.ylim(0,1) 
ax2_1.set_title("Case 4, n=500", fontsize=10) 
...
plt.ylim(0,1) 
ax2_2.set_title("Case 4, n=1000", fontsize=10)
...
plt.ylim(0,1) 
ax2_3.set_title("Case 4, n=2000", fontsize=10) 
