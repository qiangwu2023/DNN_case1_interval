...
Set_lr = np.array([2.6e-4, 3e-4, 4e-4]) # learning rate
...
ax1_1.set_title("Case 1, n=500",fontsize=10) # Set title and size
...
plt.ylim(-2,2) # Set vertical coordinate scale
ax1_2.set_title("Case 1, n=1000",fontsize=10) # Set title and size
...
plt.ylim(-2,2) # Set vertical coordinate scale
ax1_3.set_title("Case 1, n=2000",fontsize=10) # Set title and size
...
ax2_1.set_title("Case 1, n=500", fontsize=10) # Set title and size
...
plt.ylim(0,1) # Set vertical coordinate scale
ax2_2.set_title("Case 1, n=1000", fontsize=10) # Set title and size
...
plt.ylim(0,1) # Set vertical coordinate scale
ax2_3.set_title("Case 1, n=2000", fontsize=10) # Set title and size
